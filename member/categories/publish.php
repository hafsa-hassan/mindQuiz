...
<body>
    ...
    <div class="member-container">
        ...
        <div class="member-content">
            ...
            <div class="content">
                <h2 class="member-post-title">Add categories</h2>
                

                <form method="post" action="publish.php" class="form-publish">
                    ...
                    <div>
                        <button type="submit" name="add-category" class="btn primary-btn">publish category</button>
                    </div>
