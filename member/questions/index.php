...
<head>
    ...
    <title>Member - publish questions</title>
</head>
...
<body>
    ...
    <div class="member-container">
        ...
        <div class="member-content">
            ...
            <h3 class="member-page-title">Questions</h3>
            <hr>
            ...
            <h3 class="member-post-title">Manage questions</h3>
                    ...
                    <tbody>
                        <?php foreach ($questions as $key => $question) : ?>
                            <tr>
                                ...
                                <td><a href="edit.php?id=<?php echo $question['id']; ?>" class="action-link" style="color: green;">Edit</a></td>
                                <td><a href="index.php?del_id=<?php echo $question['id']; ?>" class="action-link" style="color: red;">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
